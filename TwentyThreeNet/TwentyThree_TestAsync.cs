...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void TestGenericAsync(string method, Dictionary<string, string> parameters, Action<TwentyThreeResult<UnknownResponse>> callback)
        {
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TestLoginAsync(Action<TwentyThreeResult<FoundUser>> callback)
        {
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TestNullAsync(Action<TwentyThreeResult<NoResponse>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TestEchoAsync(Dictionary<string, string> parameters, Action<TwentyThreeResult<EchoResponseDictionary>> callback)
        {
