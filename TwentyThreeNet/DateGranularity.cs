...
{
    /// <summary>
    /// DateGranularity, used for setting taken date in <see cref="TwentyThree.PhotosSetDates(string, DateTime, DateGranularity)"/> 
    /// or <see cref="TwentyThree.PhotosSetDates(string, DateTime, DateTime, DateGranularity)"/>.
    /// </summary>
