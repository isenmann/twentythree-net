...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void PhotosTransformRotateAsync(string photoId, int degrees, Action<TwentyThreeResult<NoResponse>> callback)
        {
            if (photoId == null)
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosUploadCheckTicketsAsync(string[] tickets, Action<TwentyThreeResult<TicketCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
