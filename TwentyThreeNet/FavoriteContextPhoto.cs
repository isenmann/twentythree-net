...
{
    /// <summary>
    /// A photo in the context of a favorite. Returned as part of a call to <see cref="TwentyThree.FavoritesGetContext(string, string)"/>.
    /// </summary>
    public sealed class FavoriteContextPhoto : Photo, ITwentyThreeParsable
    {
        /// <summary>
