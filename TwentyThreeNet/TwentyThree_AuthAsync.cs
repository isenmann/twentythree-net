...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void AuthGetTokenAsync(string frob, Action<TwentyThreeResult<Auth>> callback)
        {
            CheckSigned();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void AuthGetFullTokenAsync(string miniToken, Action<TwentyThreeResult<Auth>> callback)
        {
            CheckSigned();
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void AuthCheckTokenAsync(Action<TwentyThreeResult<Auth>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void AuthCheckTokenAsync(string token, Action<TwentyThreeResult<Auth>> callback)
        {
            CheckSigned();
