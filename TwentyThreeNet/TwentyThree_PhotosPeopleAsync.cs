...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void PhotosPeopleAddAsync(string photoId, string userId, Action<TwentyThreeResult<NoResponse>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosPeopleAddAsync(string photoId, string userId, int? personX, int? personY, int? personWidth, int? personHeight, Action<TwentyThreeResult<NoResponse>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosPeopleDeleteAsync(string photoId, string userId, Action<TwentyThreeResult<NoResponse>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosPeopleDeleteCoordsAsync(string photoId, string userId, Action<TwentyThreeResult<NoResponse>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// <param name="personHeight">The height (in pixels) of the box around the person.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosPeopleEditCoordsAsync(string photoId, string userId, int personX, int personY, int personWidth, int personHeight, Action<TwentyThreeResult<NoResponse>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosPeopleGetListAsync(string photoId, Action<TwentyThreeResult<PhotoPersonCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
