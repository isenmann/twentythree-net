...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PeopleGetPhotosAsync(Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PeopleGetPhotosAsync(int page, int perPage, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
            PeopleGetPhotosAsync(null, SafetyLevel.None, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue,
                                 DateTime.MinValue, ContentTypeSearch.None, PrivacyFilter.None, PhotoSearchExtras.None,
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PeopleGetPhotosAsync(PhotoSearchExtras extras, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
            PeopleGetPhotosAsync(null, SafetyLevel.None, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue,
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PeopleGetPhotosAsync(string userId, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PeopleGetPhotosOfAsync(Action<TwentyThreeResult<PeoplePhotoCollection>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PeopleGetPhotosOfAsync(string userId, Action<TwentyThreeResult<PeoplePhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PeopleGetPhotosOfAsync(string userId, PhotoSearchExtras extras, Action<TwentyThreeResult<PeoplePhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PeopleGetPhotosOfAsync(string userId, int page, int perPage, Action<TwentyThreeResult<PeoplePhotoCollection>> callback)
        {
        ...
        /// <param name="page">The page of photos to return. Default is 1.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PeopleGetPhotosOfAsync(string userId, PhotoSearchExtras extras, int page, int perPage, Action<TwentyThreeResult<PeoplePhotoCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
