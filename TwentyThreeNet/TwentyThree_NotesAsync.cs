...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosNotesEditAsync(string noteId, int noteX, int noteY, int noteWidth, int noteHeight, string noteText, Action<TwentyThreeResult<NoResponse>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosNotesDeleteAsync(string noteId, Action<TwentyThreeResult<NoResponse>> callback)
        {
            var parameters = new Dictionary<string, string>();
