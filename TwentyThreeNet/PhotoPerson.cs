...
namespace TwentyThreeNet
{
    ...
    /// <summary>
    /// The <see cref="PhotoPerson"/> class contains details returned by the <see cref="TwentyThree.PhotosPeopleGetList"/>
    /// method.
    /// </summary>
    public sealed class PhotoPerson : ITwentyThreeParsable
    {
        ...
        public string PhotostreamUrl
        {
            get
            {
                return "https://www.23hq.com/photos/" + (string.IsNullOrEmpty(PathAlias) ? UserId : PathAlias);
            }
        }
        /// <summary>
