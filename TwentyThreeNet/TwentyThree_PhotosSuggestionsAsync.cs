...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void PhotosSuggestionsApproveSuggestionAsync(string suggestionId, Action<TwentyThreeResult<NoResponse>> callback)
        {
        ...
        /// <param name="callback"></param>
        /// <returns></returns>
        public void PhotosSuggestionsGetListAsync(string photoId, SuggestionStatus status, Action<TwentyThreeResult<SuggestionCollection>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// <summary>
        /// Rejects a suggestion made for a location on a photo. Currently doesn't appear to actually work. Just use <see cref="TwentyThree.PhotosSuggestionsRemoveSuggestion"/> instead.
        /// </summary>
        /// <param name="suggestionId">The ID of the suggestion to remove.</param>
        /// <param name="callback"></param>
        public void PhotosSuggestionsRejectSuggestionAsync(string suggestionId, Action<TwentyThreeResult<NoResponse>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// <param name="callback"></param>
        public void PhotosSuggestionsRemoveSuggestionAsync(string suggestionId, Action<TwentyThreeResult<NoResponse>> callback)
        {
            CheckRequiresAuthentication();
        ...
        public void PhotosSuggestionsSuggestLocationAsync(string photoId, double latitude, double longitude,
                                                          ...
                                                          string note, Action<TwentyThreeResult<NoResponse>> callback)
        {
            CheckRequiresAuthentication();
