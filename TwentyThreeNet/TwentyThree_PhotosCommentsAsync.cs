...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void PhotosCommentsGetListAsync(string photoId, Action<TwentyThreeResult<PhotoCommentCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosCommentsDeleteCommentAsync(string commentId, Action<TwentyThreeResult<NoResponse>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosCommentsEditCommentAsync(string commentId, string commentText, Action<TwentyThreeResult<NoResponse>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// </summary>
        /// <returns></returns>
        public void PhotosCommentsGetRecentForContactsAsync(Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosCommentsGetRecentForContactsAsync(int page, int perPage, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        public void PhotosCommentsGetRecentForContactsAsync(DateTime dateLastComment, PhotoSearchExtras extras, int page,
                                                            int perPage, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
