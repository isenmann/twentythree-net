...
{
    /// <summary>
    /// Detailed information about a place. Returned by <see cref="TwentyThree.PlacesGetInfo"/>.
    /// </summary>
    public sealed class PlaceInfo : ITwentyThreeParsable
    {
        /// <summary>
        ...
        public string PlaceFlickrUrl
        {
            get
            {
                return "https://www.23hq.com/places" + PlaceUrl;
            }
        }
