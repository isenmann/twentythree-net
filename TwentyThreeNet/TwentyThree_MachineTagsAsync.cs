...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void MachineTagsGetNamespacesAsync(Action<TwentyThreeResult<NamespaceCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetNamespacesAsync(int page, int perPage, Action<TwentyThreeResult<NamespaceCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetNamespacesAsync(string predicate, Action<TwentyThreeResult<NamespaceCollection>> callback)
        {
        ...
        /// <param name="perPage">Number of photos to return per page. If this argument is omitted, it defaults to 100. The maximum allowed value is 500.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetNamespacesAsync(string predicate, int page, int perPage, Action<TwentyThreeResult<NamespaceCollection>> callback)
        {
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetPredicatesAsync(Action<TwentyThreeResult<PredicateCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetPredicatesAsync(int page, int perPage, Action<TwentyThreeResult<PredicateCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetPredicatesAsync(string namespaceName, Action<TwentyThreeResult<PredicateCollection>> callback)
        {
        ...
        /// <param name="perPage">Number of namespaces to return per page. If this argument is omitted, it defaults to 100. The maximum allowed value is 500.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetPredicatesAsync(string namespaceName, int page, int perPage, Action<TwentyThreeResult<PredicateCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetPairsAsync(Action<TwentyThreeResult<PairCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetPairsAsync(int page, int perPage, Action<TwentyThreeResult<PairCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetPairsAsync(string namespaceName, string predicate, Action<TwentyThreeResult<PairCollection>> callback)
        {
        ...
        /// <param name="perPage">Number of pairs to return per page. If this argument is omitted, it defaults to 100. The maximum allowed value is 500.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetPairsAsync(string namespaceName, string predicate, int page, int perPage, Action<TwentyThreeResult<PairCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetValuesAsync(string namespaceName, string predicate, Action<TwentyThreeResult<ValueCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetValuesAsync(string namespaceName, string predicate, int page, int perPage, Action<TwentyThreeResult<ValueCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetRecentValuesAsync(DateTime addedSince, Action<TwentyThreeResult<ValueCollection>> callback)
        {
        ...
        /// <param name="perPage">Number of values to return per page. If this argument is omitted, it defaults to 100. The maximum allowed value is 500.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetRecentValuesAsync(DateTime addedSince, int page, int perPage, Action<TwentyThreeResult<ValueCollection>> callback)
        {
        ...
        /// <param name="predicate">The predicate that all values should be restricted to.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetRecentValuesAsync(string namespaceName, string predicate, Action<TwentyThreeResult<ValueCollection>> callback)
        {
        ...
        /// <param name="perPage">Number of values to return per page. If this argument is omitted, it defaults to 100. The maximum allowed value is 500.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetRecentValuesAsync(string namespaceName, string predicate, int page, int perPage, Action<TwentyThreeResult<ValueCollection>> callback)
        {
        ...
        /// <param name="perPage">Number of values to return per page. If this argument is omitted, it defaults to 100. The maximum allowed value is 500.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void MachineTagsGetRecentValuesAsync(string namespaceName, string predicate, DateTime addedSince, int page, int perPage, Action<TwentyThreeResult<ValueCollection>> callback)
        {
