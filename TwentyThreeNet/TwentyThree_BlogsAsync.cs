...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        /// <remarks></remarks>
        public void BlogsGetListAsync(Action<TwentyThreeResult<BlogCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void BlogsPostPhotoAsync(string blogId, string photoId, string title, string description, Action<TwentyThreeResult<NoResponse>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void BlogsPostPhotoAsync(string blogId, string photoId, string title, string description, string blogPassword, Action<TwentyThreeResult<NoResponse>> callback)
        {
            var parameters = new Dictionary<string, string>();
