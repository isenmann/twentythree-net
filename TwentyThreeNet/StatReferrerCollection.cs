...
namespace TwentyThreeNet
{
    ...
    /// A list of referrers.
    /// </summary>
    public sealed class StatReferrerCollection : System.Collections.ObjectModel.Collection<StatReferrer>, ITwentyThreeParsable
    {
        /// <summary>
        ...
        void ITwentyThreeParsable.Load(System.Xml.XmlReader reader)
        {
            ...
            while (reader.LocalName == "referrer")
            {
                ...
                ((ITwentyThreeParsable)referrer).Load(reader);
                Add(referrer);
            }
