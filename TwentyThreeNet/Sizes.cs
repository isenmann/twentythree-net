...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class SizeCollection : System.Collections.ObjectModel.Collection<Size>, ITwentyThreeParsable
    {
        void ITwentyThreeParsable.Load(System.Xml.XmlReader reader)
        {
            ...
            {
                var size = new Size();
                ((ITwentyThreeParsable)size).Load(reader);
                Add(size);
            }
    ...
    /// </summary>
    public sealed class Size : ITwentyThreeParsable
    {
        /// <summary>
