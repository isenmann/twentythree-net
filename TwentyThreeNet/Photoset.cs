...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class Photoset : ITwentyThreeParsable
    {
        private string url;
        ...
        public string Url
        {
            get
            {
                return string.Format(System.Globalization.CultureInfo.InvariantCulture, "http://www.23hq.com/{0}/album/{1}", OwnerId, PhotosetId);
            }
            set { url = value; }
        }
