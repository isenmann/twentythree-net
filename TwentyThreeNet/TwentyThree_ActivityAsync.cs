...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void ActivityUserPhotosAsync(Action<TwentyThreeResult<ActivityItemCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ActivityUserPhotosAsync(int page, int perPage, Action<TwentyThreeResult<ActivityItemCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ActivityUserPhotosAsync(int timePeriod, string timeType, Action<TwentyThreeResult<ActivityItemCollection>> callback)
        {
        ...
        /// <param name="perPage">The number of activities to return per page.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ActivityUserPhotosAsync(int timePeriod, string timeType, int page, int perPage, Action<TwentyThreeResult<ActivityItemCollection>> callback)
        {
            if (timePeriod == 0)
        ...
        private void ActivityUserPhotosAsync(string timeframe, int page, int perPage, Action<TwentyThreeResult<ActivityItemCollection>> callback)
        {
        ...
        /// <param name="perPage">The number of activities to return per page.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ActivityUserCommentsAsync(int page, int perPage, Action<TwentyThreeResult<ActivityItemCollection>> callback)
        {
            CheckRequiresAuthentication();
