...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    /// <remarks>
    /// Used by the Url methods and <see cref="TwentyThree.GroupsGetInfo"/> method.
    /// The reason for a <see cref="Group"/> and <see cref="GroupFullInfo"/> are due to xml serialization
    /// incompatabilities.
    /// </remarks>
    public sealed class GroupFullInfo : ITwentyThreeParsable
    {
        /// <remarks/>
        ...
        public string GroupIconUrl
        {
            get
            {
                return UtilityMethods.BuddyIcon(GroupId);
            }
        }
