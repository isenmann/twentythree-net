...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void CollectionsGetInfoAsync(string collectionId, Action<TwentyThreeResult<CollectionInfo>> callback)
        {
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void CollectionsGetTreeAsync(Action<TwentyThreeResult<CollectionCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void CollectionsGetTreeAsync(string collectionId, string userId, Action<TwentyThreeResult<CollectionCollection>> callback)
        {
