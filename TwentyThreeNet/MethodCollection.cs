...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class MethodCollection : System.Collections.ObjectModel.Collection<string>, ITwentyThreeParsable
    {
    ...
    /// of methods.
    /// </remarks>
    public sealed class Method : ITwentyThreeParsable
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
       ...
       public string Explanation { get; set; }
        ...
        void ITwentyThreeParsable.Load(XmlReader reader)
        {
            ...
            while (reader.LocalName == "argument")
            {
                ...
                ((ITwentyThreeParsable)a).Load(reader);
                Arguments.Add(a);
            }
    ...
    /// </summary>
    public sealed class MethodArgument : ITwentyThreeParsable
    {
        /// <summary>
    ...
    /// </summary>
    public sealed class MethodError : ITwentyThreeParsable
    {
        /// <summary>
