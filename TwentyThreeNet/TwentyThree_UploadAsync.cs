...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void UploadPictureAsync(Stream stream, string fileName, string title, string description, string tags,
                                       ...
                                       Action<TwentyThreeResult<string>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ReplacePictureAsync(Stream stream, string fileName, string photoId, Action<TwentyThreeResult<string>> callback)
        {
        ...
        private void UploadDataAsync(Stream imageStream, string fileName, Uri uploadUri, Dictionary<string, string> parameters, Action<TwentyThreeResult<string>> callback)
        {
            ...
            string authHeader = String.Empty; // TwentyThreeResponder.OAuthCalculateAuthHeader(parameters);
