...
{
    /// <summary>
    /// A list of popular photos as returned by <see cref="TwentyThree.StatsGetPopularPhotos(DateTime, PopularitySort, int, int)"/>
    /// </summary>
    public sealed class PopularPhotoCollection : System.Collections.ObjectModel.Collection<PopularPhoto>, ITwentyThreeParsable
    {
        /// <summary>
