...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class Gallery : ITwentyThreeParsable
    {
        /// <summary>
        ...
        /// <summary>
        /// The URL of the medium image for the primary image for this gallery. For large sizes call <see cref="TwentyThree.PhotosGetSizes(string)"/>
        /// </summary>
