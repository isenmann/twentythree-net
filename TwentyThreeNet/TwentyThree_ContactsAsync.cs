...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void ContactsGetListAsync(Action<TwentyThreeResult<ContactCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ContactsGetListAsync(int page, int perPage, Action<TwentyThreeResult<ContactCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ContactsGetListAsync(string filter, Action<TwentyThreeResult<ContactCollection>> callback)
        {
        ...
        /// <param name="perPage">Number of contacts to return per page. If this argument is omitted, it defaults to 1000. The maximum allowed value is 1000.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ContactsGetListAsync(string filter, int page, int perPage, Action<TwentyThreeResult<ContactCollection>> callback)
        {
        ...
        /// </remarks>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ContactsGetListRecentlyUploadedAsync(Action<TwentyThreeResult<ContactCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ContactsGetListRecentlyUploadedAsync(string filter, Action<TwentyThreeResult<ContactCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ContactsGetListRecentlyUploadedAsync(DateTime dateLastUpdated, Action<TwentyThreeResult<ContactCollection>> callback)
        {
        ...
        /// Default value is "all".</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ContactsGetListRecentlyUploadedAsync(DateTime dateLastUpdated, string filter, Action<TwentyThreeResult<ContactCollection>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ContactsGetPublicListAsync(string userId, Action<TwentyThreeResult<ContactCollection>> callback)
        {
        ...
        /// <param name="perPage">Number of contacts to return per page. If this argument is omitted, it defaults to 1000. The maximum allowed value is 1000.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void ContactsGetPublicListAsync(string userId, int page, int perPage, Action<TwentyThreeResult<ContactCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <returns></returns>
        public void ContactsGetTaggingSuggestionsAsync(Action<TwentyThreeResult<ContactCollection>> callback)
        {
        ...
        /// <param name="callback">Callback action to return result (or error) to.</param>
        /// <returns></returns>
        public void ContactsGetTaggingSuggestionsAsync(int page, int perPage, Action<TwentyThreeResult<ContactCollection>> callback)
        {
            CheckRequiresAuthentication();
