...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class FoundUser : ITwentyThreeParsable
    {
        /// <summary>
        ...
        /// <summary>
        /// The full name of the user. Only returned by <see cref="TwentyThree.AuthGetToken"/>.
        /// </summary>
    ...
    /// <summary>
    /// The upload status of the user, as returned by <see cref="TwentyThree.PeopleGetUploadStatus"/>.
    /// </summary>
    public sealed class UserStatus : ITwentyThreeParsable
    {
        /// <summary>
