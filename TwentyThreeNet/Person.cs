...
namespace TwentyThreeNet
{
    ...
    /// <summary>
    /// The <see cref="Person"/> class contains details returned by the <see cref="TwentyThree.PeopleGetInfo"/>
    /// method.
    /// </summary>
    public sealed class Person : ITwentyThreeParsable
    {
    ...
    /// </summary>
    public sealed class PersonPhotosSummary : ITwentyThreeParsable
    {
