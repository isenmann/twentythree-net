...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void InterestingnessGetListAsync(PhotoSearchExtras extras, int page, int perPage, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void InterestingnessGetListAsync(DateTime date, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void InterestingnessGetListAsync(Action<TwentyThreeResult<PhotoCollection>> callback)
        {
