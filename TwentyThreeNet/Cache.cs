    ...
    public static class Cache
    {
        ...
        public static bool CacheDisabled
        {
            get
            {
                ...
                if (cacheDisabled == Tristate.Null && TwentyThreeConfigurationManager.Settings != null)
                    cacheDisabled = TwentyThreeConfigurationManager.Settings.CacheDisabled ? Tristate.True : Tristate.False;
#endif
        ...
        public static string CacheLocation
        {
            ...
            {
#if !(WindowsCE || MONOTOUCH || SILVERLIGHT)
                if (cacheLocation == null && TwentyThreeConfigurationManager.Settings != null)
                    cacheLocation = TwentyThreeConfigurationManager.Settings.CacheLocation;
#endif
