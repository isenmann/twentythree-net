...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class GalleryCollection : Collection<Gallery>, ITwentyThreeParsable
    {
                /// <summary>
        ...
        /// <summary>
        /// The owner of these galleries if called from <see cref="TwentyThree.GalleriesGetList(string, int, int)"/>.
        /// </summary>
        public string UserId { get; set; }

        /// <summary>
        /// The ID photo that these galleries contain if called from <see cref="TwentyThree.GalleriesGetListForPhoto(string, int, int)"/>.
        /// </summary>
        ...
        void ITwentyThreeParsable.Load(System.Xml.XmlReader reader)
        {
            ...
            {
                var r = new Gallery();
                ((ITwentyThreeParsable)r).Load(reader);
                Add(r);
            }
