...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    /// <remarks>Used by <see cref="TwentyThree.GroupsBrowse()"/> and
    /// <see cref="TwentyThree.GroupsBrowse(string)"/>.</remarks>
    public class Group
    {
        /// <summary>
        /// The id of the group.
    ...
    /// </summary>
    public sealed class GroupThrottleInfo : ITwentyThreeParsable
    {
        /// <summary>
    ...
    /// </summary>
    public sealed class GroupInfoRestrictions : ITwentyThreeParsable
    {
        /// <summary>
