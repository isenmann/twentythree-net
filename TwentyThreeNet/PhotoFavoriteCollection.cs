...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class PhotoFavoriteCollection : System.Collections.ObjectModel.Collection<PhotoFavorite>, ITwentyThreeParsable
    {
        /// <summary>
        /// The ID of the photo.
        /// </summary>
        ...
        void ITwentyThreeParsable.Load(XmlReader reader)
        {
            ...
            while (reader.LocalName == "person")
            {
                ...
                ((ITwentyThreeParsable)favorite).Load(reader);
                Add(favorite);
            }
