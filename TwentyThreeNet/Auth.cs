...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    [Serializable]
    public sealed class Auth : ITwentyThreeParsable
    {

        /// <summary>
        /// The authentication token returned by the <see cref="TwentyThree.AuthGetToken"/> or <see cref="TwentyThree.AuthCheckToken(string)"/> methods.
        /// </summary>
