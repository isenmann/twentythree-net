...
{
    /// <summary>
    /// Contains the raw response from Flickr when an unknown method has been called. Used by <see cref="TwentyThree.TestGeneric"/>.
    /// </summary>
    public sealed class UnknownResponse : ITwentyThreeParsable
    {
        /// <summary>
