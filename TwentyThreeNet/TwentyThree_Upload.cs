...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        /// <exception cref="TwentyThreeApiException">Thrown when Flickr returns an error. see http://www.flickr.com/services/api/upload.api.html for more details.</exception>
        ...
        private string UploadData(Stream imageStream, string fileName, Uri uploadUri, Dictionary<string, string> parameters)
        {
            ...
            if( stream == null) throw new TwentyThreeWebException("Unable to retrieve stream from web response.");
