...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class Cluster : ITwentyThreeParsable
    {
        /// <summary>
        ...
        public string ClusterUrl
        {
            get
            {
                return string.Format(System.Globalization.CultureInfo.InvariantCulture, "https://www.23hq.com/photos/tags/{0}/clusters/{1}/", SourceTag, ClusterId);
            }
        }
