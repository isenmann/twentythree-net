...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class Contact : ITwentyThreeParsable
    {
        /// <summary>
        ...
        /// <summary>
        /// The users real name. Only returned for authenticated calls to <see cref="TwentyThree.ContactsGetList()"/>.
        /// </summary>
        public string RealName { get; set; }

        /// <summary>
        /// The location of the contact. Only returned for auehtnicated calls to <see cref="TwentyThree.ContactsGetList()"/>.
        /// </summary>
        public string Location { get; set; }

        /// <summary>
        /// The URL path alias for the contact.  Only returned for auehtnicated calls to <see cref="TwentyThree.ContactsGetList()"/>.
        /// </summary>
        ...
        /// <summary>
        /// The number of photos uploaded. Only returned by <see cref="TwentyThree.ContactsGetListRecentlyUploaded()"/>
        /// </summary>
