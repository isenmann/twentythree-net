...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class PeoplePhotoCollection : System.Collections.ObjectModel.Collection<Photo>, ITwentyThreeParsable
    {
        /// <summary>
        /// Only populate for authenticated calls to <see cref="TwentyThree.PeopleGetPhotosOf()"/>
        /// </summary>
