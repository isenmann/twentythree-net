...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class PhotosetCollection : System.Collections.ObjectModel.Collection<Photoset>, ITwentyThreeParsable
    {
        /// <summary>
        ...
        void ITwentyThreeParsable.Load(System.Xml.XmlReader reader)
        {
            ...
            while (reader.LocalName == "photoset")
            {
                ...
                ((ITwentyThreeParsable)photoset).Load(reader);
                Add(photoset);
            }
