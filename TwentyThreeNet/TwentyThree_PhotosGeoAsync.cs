...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void PhotosGeoBatchCorrectLocationAsync(double latitude, double longitude, GeoAccuracy accuracy, string placeId, string woeId, Action<TwentyThreeResult<NoResponse>> callback)
        {
        ...
        /// <param name="woeId">A Where On Earth (WOE) ID. (While optional, you must pass either a valid Places ID or a WOE ID.)</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosGeoCorrectLocationAsync(string photoId, string placeId, string woeId, Action<TwentyThreeResult<NoResponse>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosGeoGetLocationAsync(string photoId, Action<TwentyThreeResult<PlaceInfo>> callback)
        {
            var parameters = new Dictionary<string, string>();
            ...
            GetResponseAsync<PhotoInfo>(
                ...
                r =>
                {
                    var result = new TwentyThreeResult<PlaceInfo>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosGeoSetContextAsync(string photoId, GeoContext context, Action<TwentyThreeResult<NoResponse>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosGeoSetLocationAsync(string photoId, double latitude, double longitude, Action<TwentyThreeResult<NoResponse>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosGeoSetLocationAsync(string photoId, double latitude, double longitude, GeoAccuracy accuracy, Action<TwentyThreeResult<NoResponse>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosGeoRemoveLocationAsync(string photoId, Action<TwentyThreeResult<NoResponse>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosGetWithoutGeoDataAsync(Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosGetWithoutGeoDataAsync(PartialSearchOptions options, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// </remarks>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosGetWithGeoDataAsync(Action<TwentyThreeResult<PhotoCollection>> callback)
        {
            var options = new PartialSearchOptions();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosGetWithGeoDataAsync(PartialSearchOptions options, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void PhotosGeoGetPermsAsync(string photoId, Action<TwentyThreeResult<GeoPermissions>> callback)
        {
            var parameters = new Dictionary<string, string>();
