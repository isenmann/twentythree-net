...
{
    /// <summary>
    /// The sort order for the <see cref="TwentyThree.PhotosSearch(PhotoSearchOptions)"/>,
    /// <see cref="TwentyThree.PhotosGetWithGeoData()"/>, <see cref="TwentyThree.PhotosGetWithoutGeoData()"/> methods.
    /// </summary>
    [Serializable]
