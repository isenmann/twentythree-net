...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetListUserAsync(Action<TwentyThreeResult<TagCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetListUserAsync(string userId, Action<TwentyThreeResult<TagCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetListUserPopularAsync(Action<TwentyThreeResult<TagCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetListUserPopularAsync(int count, Action<TwentyThreeResult<TagCollection>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// <param name="userId">The NSID of the user to fetch the tag list for. If this argument is not specified, the currently logged in user (if any) is assumed.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetListUserPopularAsync(string userId, Action<TwentyThreeResult<TagCollection>> callback)
        {
        ...
        /// <param name="count">Number of popular tags to return. defaults to 10 when this argument is not present.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetListUserPopularAsync(string userId, int count, Action<TwentyThreeResult<TagCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetListUserRawAsync(Action<TwentyThreeResult<RawTagCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetListUserRawAsync(string tag, Action<TwentyThreeResult<RawTagCollection>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// </summary>
        /// <returns></returns>
        public void TagsGetMostFrequentlyUsedAsync(Action<TwentyThreeResult<TagCollection>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetRelatedAsync(string tag, Action<TwentyThreeResult<TagCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetClustersAsync(string tag, Action<TwentyThreeResult<ClusterCollection>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetClusterPhotosAsync(Cluster cluster, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetClusterPhotosAsync(Cluster cluster, PhotoSearchExtras extras, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetHotListAsync(Action<TwentyThreeResult<HotTagCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void TagsGetHotListAsync(string period, int count, Action<TwentyThreeResult<HotTagCollection>> callback)
        {
