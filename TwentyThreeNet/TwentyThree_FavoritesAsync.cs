...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        public void FavoritesAddAsync(string photoId, Action<TwentyThreeResult<NoResponse>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void FavoritesRemoveAsync(string photoId, Action<TwentyThreeResult<NoResponse>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void FavoritesGetListAsync(Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void FavoritesGetListAsync(PhotoSearchExtras extras, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void FavoritesGetListAsync(int page, int perPage, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="page">The page to download this time.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void FavoritesGetListAsync(PhotoSearchExtras extras, int page, int perPage, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void FavoritesGetListAsync(string userId, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="extras">The extras to return for each photo.</param>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void FavoritesGetListAsync(string userId, PhotoSearchExtras extras, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void FavoritesGetPublicListAsync(string userId, Action<TwentyThreeResult<PhotoCollection>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        /// <returns></returns>
        public void FavoritesGetContextAsync(string photoId, string userId, Action<TwentyThreeResult<FavoriteContext>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        /// <returns></returns>
        public void FavoritesGetContextAsync(string photoId, string userId, PhotoSearchExtras extras, Action<TwentyThreeResult<FavoriteContext>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        /// <returns></returns>
        public void FavoritesGetContextAsync(string photoId, string userId, int numPrevious, int numNext, Action<TwentyThreeResult<FavoriteContext>> callback)
        {
