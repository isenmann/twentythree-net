...
namespace TwentyThreeNet
{
    ...
    /// </summary>
    public sealed class Blog : ITwentyThreeParsable
    {
        /// <summary>
        /// The ID Flickr has assigned to the blog. Use this to post to the blog using 
        /// <see cref="TwentyThree.BlogsPostPhoto(string, string, string, string)"/> or 
        /// <see cref="TwentyThree.BlogsPostPhoto(string, string, string, string, string)"/>. 
        /// </summary>
        ...
        /// <summary>
        /// The service that his blog uses. See <see cref="TwentyThree.BlogsGetServices()"/>
        /// </summary>
