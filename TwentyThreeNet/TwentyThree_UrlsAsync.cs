...
namespace TwentyThreeNet
{
    public partial class TwentyThree
    {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void UrlsGetUserPhotosAsync(Action<TwentyThreeResult<string>> callback)
        {
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void UrlsGetUserPhotosAsync(string userId, Action<TwentyThreeResult<string>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// </summary>
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void UrlsGetUserProfileAsync(Action<TwentyThreeResult<string>> callback)
        {
            CheckRequiresAuthentication();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void UrlsLookupGalleryAsync(string url, Action<TwentyThreeResult<Gallery>> callback)
        {
            var parameters = new Dictionary<string, string>();
        ...
        /// <param name="callback">Callback method to call upon return of the response from Flickr.</param>
        public void UrlsLookupUserAsync(string urlToFind, Action<TwentyThreeResult<FoundUser>> callback)
        {
            var parameters = new Dictionary<string, string>();
